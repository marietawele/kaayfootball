...
export class AddEntrepriseComponent {
  ...
  get f(): any {
    return this.reactiveForm_add_entreprise.controls;
  }
  ...
  add_entreprise(entreprise: any) {
    ...
    this.api.taf_post(
      ...
      (reponse: any) => {
        ...
        if (reponse.status) {
          console.log(
            'Opération effectuée avec succés sur la table entreprise. Réponse= ',
            reponse
          );
          ...
          console.log(
            "L'opération sur la table entreprise a échoué. Réponse= ",
            reponse
          );
